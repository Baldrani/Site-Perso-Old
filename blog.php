...
<body>  <?php include ('analyticstracking.php'); ?>
  <div class="wrapper">
    ...
    <div class="container" align="justify">
      <div class="row">
        <div class="col-xs-12">
          <p id="intro_blog"><em>Nous voici arrivés à la partie blog de ce site. Si ce dernier en est doté c'est à la fois pour partager mes découvertes, mes coups de coeur mais aussi pour le vivifier et peut être avant tout car j'aime me livrer à l'exercice de la rédaction et que cette section en est le support parfait. J'espère que vous apprécierez ces quelques articles qui suivent et qu'ils vous donneront envie de découvrir un peu plus mon univers.</em></p>

		    <div class="col-sm-7 col-xs-12">
		        <h2 class= "titre_blog">Candide is back again !</h2>
		        <h5>Posté le : 23 février 2016</h5>
		        <p>Un simple petit coucou juste parce que Candide ! <br><br>
		          <iframe width="560" height="315" src="https://www.youtube.com/embed/R1NagZN2kjY" frameborder="0" allowfullscreen></iframe>
		        </p>
		    </div>

          <div class="col-sm-7 col-xs-12">
            <h2 class= "titre_blog">Mr Robot</h2>
            <h5>Posté le : 13 septembre 2015</h5>
            <p align="justify" >Après avoir été repoussé d’une semaine à cause de la resemblance un peu trop marquée entre une scène du finale et l’ <a href="http://edition.cnn.com/2015/08/26/us/virginia-shooting-wdbj/"> assassinat  des deux journalistes américains</a>, notre dernier épisode est finalement sorti et comme prévu, vous allez devoir bien vous accrocher.
			<br/><br/>
			C'est donc après visionnage de ce final que nous allons pouvoir parler un peu d'une excellente série encore sortie dans le courant de cet année 2015, décidément riche en émotion.
			<br/><br/>
			Elliot, jeune programmeur et génie du hacking souffrant de gros troubles du comportement, est contacté par un mystérieux homme prénommé Mr Robot.
			Son but: faire appel aux talents d'Elliot afin de renverser la société économique actuelle.
			Derrière cette trame, somme toute triviale, se développe une histoire gravitant autour de la personnalité d'un hacker névrosé antisocial et quelques peu "creepy", qui passe le plus clair de son temps libre à fouiller l'intimité de quiconque croise son chemin. S'entre coupe par la suite histoires de cartel, jeux de pouvoir, assassinat et intrigues quant aux différents personnages.
			<br/><br/>
			...
			<br/><br/>
			En attendant, la saison 1 a piqué ma curiosité et j'ai hate de découvrir les denouements de la prochaine saison.
			</p>
          </div>
          ...
          <div class="col-sm-7 col-xs-12">
            <h2 class= "titre_blog">Red Bull Hardline 2015</h2>
            <h5>Posté le : 12 septembre 2015</h5>
            <p align="justify" >La descente a VTT la plus éprouvante jamais conçue c'est ce weekend au Pays de Galles et ça nous est proposé bien évidemment par Redbull. Fidèle à soit même la marque qui donne des ailes n'a pas plaisanté avec la conception du terrain ! Mieux vaut être bien accroché ! Le double champion du monde <a href="https://fr.wikipedia.org/wiki/Gee_Atherton" alt="Gee Atherton">Gee Atherton</a> l'a testée pour nous : admirez !<br/><br/>
            <iframe width="560" height="315" src="https://www.youtube.com/embed/eagElg8YnZY" frameborder="0" allowfullscreen></iframe>
          ...
          <div class="col-sm-7 col-xs-12">
            <h2 class= "titre_blog">How To Get Away With Murder</h2>
            <h5>Posté le : 15 aôut 2015</h5>
            <p align="justify" > 	
            Me revoilà pour vous parler d’une petite série que j’ai découvert cette été.<br/>
            ...
            Les épisodes vont alors s’enchainer alliant séance au tribunal pour disculper des coupables dont le procès semble ingagnable et échange presque familiale entre les différents membres du cabinets d’avocats le toute associé à quelques flashforward nous délivrants au compte goûte des informations sur le moment où leurs vie va basculer. C’est dans cette atmosphère que l’on va finalement s’attacher aux personnages et suivre à leurs côtés leurs quotidiens plutôt mouvementées.<br/><br/>
          ...
          <div class="col-sm-7 col-xs-12">
            <h2 class="titre_blog">Monster</h2>
            <h5>Posté le : 27 mai 2015</h5>
            <p align="justify">
              ...
              <br /><br />
              Neuf ans plus tard Dr Tenma est à nouveau embarqué dans une histoire d'homicide déterrant ainsi son ancienne accusation, ne lui laissant alors pas d'autres choix que de fuir la police qui l'accuse d'être le coupable de tous ces crimes. Mais il s'avère que cette fois-ci le neurochirurgien a assisté à l'homicide et ce n'est autre que <strong>Johan</strong>, le petit enfant qu'il a sauvé d'une balle dans la tête il y a de cela des années qui en est le perpétrateur. Tenma va alors tenter durant sa cavale de percer les nombreux mystères qui gravitent autour de Johan, que ceux qui l'on rencontré et peuvent encore en témoigner semblent considérer comme un <strong>monstre</strong>. 
              <br/><br/>
              L'histoire va alors nous entrainer dans un thriller à mi chemin entre fiction et faits historiques tournant autour de l'intrigue de ce jeune homme psychopathe et de sa soeur jumelle qui a repris une vie normale mais n'a plus aucun souvenir de son enfance. Envoutant ce manga m'a fait frémir jusqu'aux dernières pages finissants en apothéose apocalyptique.  
              <br/><br/>
              Si après ça vous n'êtes toujours pas tentés ou tout simplement n'êtes pas fan de la lecture; sachez que le chef d'oeuvre de <strong><a href="http://fr.wikipedia.org/wiki/Naoki_Urasawa" alt="Naoki Urasawa">Naoki Urasawa</a></strong> a été adapté en animé qui lui aussi a eu un franc succès. Plus d'excuse pour ne pas y jeter un coup d'oeil !   
            </p>
          </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-7 col-xs-12">
            <h2 class= "titre_blog">Le Ski C’est Fini..</h2>
            <h5>Posté le : 13 avril 2015</h5>
            <p>L’été approche et il est temps de tirer un trait définitivement sur les sports d’hiver. Et pour conclure cette magnifique saison quoi de mieux que la réalisation d’une figure inédite !<br/><br/> Tout droit venu de norvège, je vous présente un flip en entré <strong>et</strong> en sortie de rail. Figure effectuée par le jeune <strong><a href="http://www.redbull.com/fr/snow/athletes/1331701016179/oystein-braaten">Øystein Bråten</a></strong> (19 ans), futur star norvégienne qui n'a de cesse que de se faire remarquer en  Slopstyle et en Big Air. Un jeune homme à surveiller de près !<br/><br/>

              <iframe width="640" height="360" frameborder="0" scrolling="no" src="http://sharevideo.redbull.com/?bckey=AQ~~,AAABTw4lHzE~,sr1E9bdX6d4wCdvdlD8QKdNij3uKs2K9&videoID=4164758809001&dynamicStreaming=true&bckey=AQ~~,AAABTw4lHzE~,sr1E9bdX6d4wCdvdlD8QKdNij3uKs2K9&jumpHover=Jump backwards&labels=http://www.redbull.com/cs/RedBull2Misc/brightcove/fr_FR_labels.xml&isUI=true&link=http://www.redbull.com/fr/fr/snow&onsiteSettings=false,false,false,true&socialHover=Share or embed&bctid=4164758809001&startTime=1428818190620&isVid=true&qualityHover=Change quality&linkBaseURL=http://www.redbull.com/fr/fr/snow/stories/1331716235669/flip-2-flip-brÃ¥ten-fait-une-premiÃ¨re-mondiale&bcpid=1684512102001&bgcolor=#000000&relatedcontent=true,true&htmlFallback=true&templateErrorHandler=document.getElementById('myExperience').errorHandler&bcpid=1684512102001&autoStart=false&closedCaptionsHover=Subtitles&bctid=4164758809001&filter=channel:Snow&isRTL=false&logoHover=Visiter RedBull.com Snow"></iframe>
              <br/><br/>
              Et juste pour le plaisir et si vous êtes passé à coté de ça, ci dessous la video de notre champion nationale <a href="http://fr.wikipedia.org/wiki/Candide_Thovex"><strong>Candide Thovex</strong></a> qui nous réalise le plus beau run de la saison ! Attention aux yeux !<br/><br/>

              <iframe class="center_iframe" width="560" height="315" src="https://www.youtube.com/embed/yKP7jQknGjs" frameborder="0" allowfullscreen></iframe>
            </p>
          </div>
          <div class="col-sm-4 col-sm-offset-1 col-xs-12">
...
<div class="container">
  <div class="row">
    <div class="col-sm-7 col-xs-12">
      <h2 class= "titre_blog">L'Attaque des Titans</h2>
      <h5>Posté le : 2 avril 2015</h5>
      <p>Des <strong>complots</strong> étriqués, des scènes d’<strong>action</strong> très prenantes et une fâcheuse tendance à perdre les personnages auxquels on s’attache. On se voit déjà en plein Game of Throne. Rajoutez maintenant une trame très sombre ou les <strong>effusions de sang</strong> sont de paires à de superbes dessins et cette fois ci vous obtenez <strong>Shingeki no Kyojin</strong> soit chez nous : <em>l'Attaque des Titans.</em><br /><br />
        ...
        Sur ce, je vous invite à vivre avec moi au rythme de ce chef d'oeuvre.
      </p>
    </div>
    <div class="col-sm-4 col-sm-offset-1 col-xs-12">
...
<div class="container">
  <div class="row">
    <div class="col-sm-7 col-xs-12">
      <h2 class="titre_blog">Chappie : L'Histoire d'un Robot un Peu Perdu</h2>
      <h5>Posté le : 18 mars 2015</h5>
      <p>Dans la lignée de ses précédents films, le chef d’oeuvre <strong><a href="http://www.allocine.fr/film/fichefilm_gen_cfilm=143026.html">District 9</a></strong>
        et l’imparfait Elysium, <Strong>Neil Blomkamp</strong>  avec son nouveau long métrage nous bluffe encore tout en conservant cette même imagerie futuro-trash mais en changeant cette fois de thématique nous parlant dorénavant de <strong>l’Intelligence Artificielle</strong>.
        La réalisation en soit même est comme à son habitude splendide et
        les personnages sont drôles et attachants, qui plus est et contrairement à ce qu’on pourrait attendre les acteurs amateurs du groupe de musique sud Africain Die Antwoord ne sont pas si catastrophiques. Cela sûrement dû au fait que ce soient les mêmes rôles d’excentriques qu’ils jouent dans leurs clips.
        Quand à notre petit robot Chappie, le pari est réussi ! Si attachant qu’on ne veut plus le quitter.<br /><br/>
        Le seul petit hic à mon goût coté acteur, est Hugh Jackman, dont le rôle est malheureusement peu glorifiant, en effet ce méchant dérange de part ses motivations quelque peu… douteuses. Malgré tout Hugh est toujours aussi bon dans son rôle… 
        Bref, un film à voir absolument pour les fans de notre cher réalisateur et pour moi l’un des meilleurs films de science-fiction de l’année !<br />
        <strong>Chapeau "Chappie" !</strong><br /><br />
        Allez ! Une petite <a target="_blank" href="http://boingboing.net/2015/03/17/die-antwoords-ninja-replies.html">interview</a> en cadeau.</p>
      </div>
